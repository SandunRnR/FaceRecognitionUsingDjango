...
firebase_admin.initialize_app(cred, options={'storageBucket': 'face-app-604bc.appspot.com'})
...
SECRET_KEY = 'django-insecure-&gjd+dvw712@-yr@)knuc-#exj*m81+f7=rv2vjbi&b#gdlcc+'
